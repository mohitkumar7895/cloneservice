  ...
  try {
    ...
    const insertQuery = `
      ...
      VALUES 
        ...
        ('Santosh kumar', '9893852800', 'PROVISIONINGTECH202603235634', '2026-03-24', NULL, 100, 'EXPIRED'),
        ('Monu Kumar Tamar', '9993251966', 'PROVISIONINGTECH202603218011', '2026-03-22', NULL, 100, 'ACTIVE'),
        ('Monu Kumar Tamar', '9993251966', 'PROVISIONINGTECH202603213937', '2026-03-22', NULL, 90, 'ACTIVE')
    `;
