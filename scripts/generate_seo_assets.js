...
async function generateAssets() {
  ...
  // 1. Convert logoprovisioningtech.webp to high-res logo.png
  const logoWebpPath = path.join(publicDir, 'logoprovisioningtech.webp');
  ...
  const svgBanner = `
    <svg width="1200" height="630" viewBox="0 0 1200 630" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="80" y="580" fill="#94a3b8" font-family="Segoe UI, Roboto, sans-serif" font-size="16">Call &amp; WhatsApp: +91 63976 50818</text>
      <text x="1120" y="580" fill="#94a3b8" font-family="Segoe UI, Roboto, sans-serif" font-size="16" text-anchor="end">www.provisioningtech.com</text>
    </svg>
  `;
