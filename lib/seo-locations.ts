...
const PHONE = "63976 50818";

function faqsFor(place: string): { q: string; a: string }[] {
  return [
    {
      q: `Do you provide RO, fridge and washing machine repair in ${place}?`,
      a: `Yes. PROVISIONINGTECH Company provides doorstep RO water purifier repair, refrigerator repair, washing machine repair and AC service in ${place}. Call ${PHONE} to book a same-day visit.`,
    },
    {
...
export const SEO_LOCATIONS: SeoLocation[] = [
  {
    ...
    intro:
      "Book certified doorstep appliance repair in Noida for RO water purifiers, refrigerators, washing machines and ACs. PROVISIONINGTECH technicians serve Sector 1–168, Noida Extension and nearby societies with upfront pricing and a 30-day service warranty.",
    faqs: faqsFor("Noida"),
  },
  {
    slug: "delhi",
    ...
    region: "Delhi",
    intro:
      "Doorstep RO, refrigerator, washing machine and AC repair across Delhi. PROVISIONINGTECH Company sends verified technicians to your home with transparent rates and genuine spare parts.",
    faqs: faqsFor("Delhi"),
  },
  {
    slug: "greater-noida",
  ...
  },
  {
    ...
    region: "Uttar Pradesh",
    intro:
      "PROVISIONINGTECH Company is based in Greater Noida West. Get fast RO, fridge, washing machine and AC repair at your society gate with a 30-day warranty.",
  ...
  },
  {
    ...
    intro:
      "Doorstep RO, refrigerator, washing machine and AC repair in Gaur City 2, 10th Avenue. Call 63976 50818 for a same-day technician visit.",
  ...
  },
  {
    ...
    region: "Noida Extension",
    intro:
      "Doorstep home appliance repair in Gaur City 2, 14th Avenue Phase 2. Call 63976 50818 to book.",
  ...
  },
  {
    ...
    kind: "society",
    intro:
      "Book RO, fridge and washing machine repair at Aishwaryam. PROVISIONINGTECH technicians reach your tower in Noida Extension with upfront rates.",
  ...
  },
  {
    ...
    kind: "society",
    intro:
      "Same-day appliance repair in Flora for RO water purifiers, refrigerators and washing machines. Call 63976 50818 to book.",
    faqs: faqsFor("Flora"),
  },
  {
  ...
  },
  {
    ...
    kind: "society",
    intro:
      "Book RO, refrigerator and washing machine repair in Aarcity Regency Park. PROVISIONINGTECH Company provides same-day doorstep service nearby Gaur City 2.",
  ...
  },
  {
    ...
    kind: "society",
    intro:
      "PROVISIONINGTECH workshop is opposite Mahagun Mywoods. Get the fastest RO, fridge and washing machine repair for Mywoods towers with a 30-day warranty.",
  ...
  },
  {
    ...
    kind: "society",
    intro:
      "Doorstep RO repair, refrigerator repair and washing machine repair in Palm Olympia. Call 63976 50818 for a same-day technician.",
