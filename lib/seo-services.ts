...
export const SEO_SERVICES: SeoService[] = [
  {
    ...
    description: (place) =>
      `Doorstep RO repair and service in ${place}. Filter change, TDS check, leakage, gas/pump issues and AMC by PROVISIONINGTECH technicians. Call ${PHONE}.`,
    intro: (place) =>
      `Need RO repair and service in ${place}? PROVISIONINGTECH Company sends a certified technician to your tower for Kent, Livpure, Aquaguard, Pureit, Aquafresh and local RO brands. Filter replacement, low water, leakage, taste/TDS issues and annual maintenance are covered with a 30-day service warranty.`,
    faqs: (place) => [
      {
  ...
  },
  {
    ...
    intro: (place) =>
      `Book refrigerator repair in ${place} for single-door, double-door, side-by-side and inverter models. PROVISIONINGTECH technicians diagnose no cooling, excess cooling, noise, water leakage and door issues at your home with genuine parts and a 30-day warranty.`,
    faqs: (place) => [
      {
