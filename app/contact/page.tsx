...
export const metadata: Metadata = {
  title: "Contact Us & Support | PROVISIONINGTECH Company Doorstep Services",
  description:
    "Contact PROVISIONINGTECH Company for fast appliance repair support in Delhi NCR. Call +91 63976 50818 or reach our Gaur City 2 hub for RO, refrigerator, and washing machine services.",
  alternates: {
  ...
  openGraph: {
    title: "Contact Us & Support | PROVISIONINGTECH Company Doorstep Services",
    description:
      "Need appliance repair in Noida, Greater Noida, Ghaziabad, or Delhi? Contact PROVISIONINGTECH Company anytime for fast doorstep assistance.",
    url: `${siteUrl}/contact`,
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Contact PROVISIONINGTECH Company",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Contact PROVISIONINGTECH Company - Customer Support",
    description:
      "Call +91 63976 50818 for doorstep appliance repair in Delhi NCR.",
    images: ["/og-image.jpg"],
  },
};
  ...
  const contactSchema = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "url": `${siteUrl}/contact`,
        "name": "Contact PROVISIONINGTECH Company",
        "description": "Customer support and booking assistance for PROVISIONINGTECH Company home appliance repair.",
        "mainEntity": {
          "@type": "LocalBusiness",
          "name": "PROVISIONINGTECH Company",
          "telephone": "+916397650818",
          "email": "support@provisioningtech.com",
          "address": {
            "@type": "PostalAddress",
