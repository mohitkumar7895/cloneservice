...
const DEFAULT_POLICIES: Record<string, PolicyData> = {
  "privacy-policy": {
    ...
    contact_email: "support@provisioningtech.com",
    sections: [
      {
      ...
      },
      {
        ...
        content: "For privacy-related concerns, contact us at: support@provisioningtech.com",
        bullets: [],
      },
    ],
  },
  "terms-and-conditions": {
    ...
    subtitle: "Effective Date: January 2026\nBy using PROVISIONINGTECH Company's website or services, you agree to the following terms and conditions.",
    last_updated: "January 2026",
    contact_email: "support@provisioningtech.com",
    sections: [
      {
        ...
        bullets: [
          "PROVISIONINGTECH Company provides home appliance repair and maintenance services through trained service professionals",
      ...
      },
      {
        ...
        bullets: [
          "PROVISIONINGTECH Company is not responsible for issues caused by misuse, power fluctuations, or improper installation by third parties",
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          "PROVISIONINGTECH Company reserves the right to update services, prices, or policies at any time",
        ],
      },
    ],
  },
  ...
  try {
    ...
    if (rows && rows.length > 0) {
      ...
      return {
        ...
        contact_email: row.contact_email || "support@provisioningtech.com",
...
export async function updatePolicy(policyData: PolicyData) {
  ...
  try {
    ...
    await pool.query(query, [
      ...
      policyData.contact_email || "support@provisioningtech.com",
