          ...
          >
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-500 text-xs">Official PROVISIONINGTECH Annual Maintenance Card</p>
              </div>
            </div>

            {/* The Digital AMC Card */}
            <div className="bg-gradient-to-br from-[#1e1b4b] via-[#312e81] to-[#4338ca] text-white rounded-2xl p-5 shadow-xl relative overflow-hidden border border-emerald-400/30">
              {/* Background Glow */}
              ...
              <div className="flex justify-between items-start mb-6">
                <div>
                  <span className="text-[10px] font-extrabold uppercase tracking-widest text-emerald-300 block mb-0.5">
                    PROVISIONINGTECH SMART PROTECTION
                  </span>
              ...
              <div className="mb-6">
                <span className="text-[10px] uppercase text-emerald-300 font-bold tracking-wider block">MEMBERSHIP PASS NO.</span>
              ...
              {/* Card Details Grid */}
              <div className="grid grid-cols-2 gap-3 pt-3 border-t border-emerald-400/20 text-xs">
                <div>
                  <span className="text-[10px] text-emerald-300 uppercase font-semibold block">CARD HOLDER</span>
                  <span className="font-bold text-white truncate block">
                    {selectedAmcCardBooking.customer_name || user?.name || "Valued Member"}
                  </span>
                </div>
                <div>
                  <span className="text-[10px] text-emerald-300 uppercase font-semibold block">CONTACT</span>
                  <span className="font-bold text-white block">
                    {selectedAmcCardBooking.mobile || "Verified Customer"}
                  </span>
                </div>
                <div>
                  <span className="text-[10px] text-emerald-300 uppercase font-semibold block">VALIDITY</span>
                ...
                <div>
                  <span className="text-[10px] text-emerald-300 uppercase font-semibold block">SERVICE INCLUSIONS</span>
