...
const TARGET_ADMIN_EMAIL = "mail.provisioningtech@gmail.com";
...
export async function POST(req: Request) {
  try {
    ...
    // Find admin by email (support registered email or mail.provisioningtech@gmail.com directly)
    ...
    // 4. Send OTP to mail.provisioningtech@gmail.com
    try {
