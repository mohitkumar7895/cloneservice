  ...
  const handleSubmit = async (userOverride?: any) => {
    ...
    try {
      ...
      if (res.ok) {
        const data = await res.json();
        setBookedItems([...cart]);
        localStorage.removeItem('provisioningtech_cart');
          ...
          <div className="bg-white sm:shadow-[0_20px_60px_rgba(0,0,0,0.04)] sm:border border-gray-100 rounded-[32px] w-full max-w-[560px] relative overflow-hidden z-10 p-8 sm:p-12">
            ...
            <div className="bg-[#fafafa] rounded-2xl p-5 sm:p-6 mb-8 border border-gray-100/80 space-y-4">
                        ...
                        <div key={idx} className="flex items-center justify-between bg-white p-3 rounded-xl border border-gray-100 shadow-2xs">
                          <div className="flex items-center gap-3 min-w-0">
                            {item.image_url ? (
                              ...
                              <div className="w-11 h-11 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center shrink-0 font-bold text-sm">🛠️</div>
                            )}
              ...
              <div className="pb-4 border-b border-gray-200/60">
                ...
                <span className={`inline-flex items-center gap-1.5 px-3 py-1 text-[12px] font-bold rounded-lg border ${paymentMethod === 'online' ? 'bg-emerald-50 text-[#6b62d9] border-emerald-200' : 'bg-gray-100 text-gray-800 border-gray-200'}`}>
                ...
                <div className="space-y-2" id="container-address">
                  ...
                  <div className="flex items-center gap-2 pt-0.5">
                        ...
                        <ul className="absolute z-20 left-0 right-0 top-full mt-1 bg-white border border-gray-200 rounded-xl shadow-xl max-h-52 overflow-y-auto divide-y divide-gray-50">
                          {addrResults.map((r, i) => (
                            <li
                              ...
                              className="px-3.5 py-2 text-xs sm:text-[13px] text-gray-800 cursor-pointer hover:bg-emerald-50 hover:text-emerald-700 font-medium transition-colors"
                            >
                              {r.label}
                            </li>
                          ))}
                    ...
                    <button
                      ...
                      className="shrink-0 text-xs font-bold text-[#6b62d9] hover:text-white hover:bg-[#6b62d9] flex items-center gap-1.5 bg-emerald-50 hover:bg-emerald-600 border border-emerald-200 px-3.5 py-2 rounded-xl transition shadow-xs active:scale-95 cursor-pointer"
          ...
          >
            ...
            <div className="bg-gradient-to-r from-[#584ec6] via-[#6b62d9] to-[#7f74e6] text-white px-5 py-4 relative">
              ...
              <div className="flex items-center justify-between pr-8">
                <div>
                  <div className="flex items-center gap-1.5 text-[10.5px] font-extrabold uppercase tracking-wider text-emerald-100">
                ...
                <div className="text-right">
                  <span className="text-[10px] font-bold text-emerald-200 block uppercase">Payable</span>
            ...
            <div className="p-4 sm:p-5 space-y-3.5">
              ...
              {/* QR Image Card */}
              <div className="bg-white rounded-2xl p-2.5 sm:p-3 border-2 border-emerald-100/90 shadow-2xs text-center relative group">
              ...
              <a
                href={`upi://pay?pa=omacr8ewa@idfcbank&pn=PROVISIONINGTECH%20CURRENTSEWA%20INDIA%20PVT%20LTD&am=${Math.round(totalAmount)}&cu=INR&tn=PROVISIONINGTECH%20Service%20Booking`}
