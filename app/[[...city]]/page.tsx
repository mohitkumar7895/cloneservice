...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (extraSegment) {
    return {
      title: absoluteTitle("Page not found | PROVISIONINGTECH Company"),
  ...
  if (keywordPage) {
    ...
    return {
      title: absoluteTitle(`${heading} | Call 63976 50818`),
      description: nestedKeyword
        ? `${keywordPage.title} in ${place}. Same-day doorstep technician. Call 63976 50818.`
        : keywordPage.description,
      keywords: [keywordPage.title, place, "Delhi NCR", "PROVISIONINGTECH Company"],
  ...
  if (!citySlug) {
    ...
    return {
      ...
      description:
        "Washing machine repair near me, refrigerator repair near me, RO repair near me and home appliance repair Noida. Same-day technician at your doorstep. Call 63976 50818.",
      keywords: [
      ...
      openGraph: {
        title: "PROVISIONINGTECH Company - Doorstep Appliance Repair | RO, Fridge, Washing Machine",
        description:
        ...
        images: [
          {
            ...
            width: 1200,
            height: 630,
            alt: "PROVISIONINGTECH Company Home Appliance Repair",
          },
        ],
      },
      twitter: {
  ...
  if (seoService && seoLocation) {
    ...
    return {
      ...
      openGraph: {
        title: `${seoService.titleKeyword} in ${locationTitle} | PROVISIONINGTECH Company`,
        description: seoService.description(locationTitle),
  ...
  if (citySlug.startsWith("gaur-city-2")) {
    return {
      title: absoluteTitle(`RO, Refrigerator & Washing Machine Repair in ${locationTitle} | Call 63976 50818`),
      description: `Expert doorstep RO repair, Refrigerator servicing, and Washing Machine repair in ${locationTitle}. Call 63976 50818 for verified technicians, instant booking, and 30-day service warranty.`,
      alternates: {
        canonical: `${siteUrl}${pagePath}`,
      },
      openGraph: {
        title: `RO, Refrigerator & Washing Machine Repair in ${locationTitle} | Call 63976 50818`,
        description: `Need RO, fridge, or washing machine repair in ${locationTitle}? Call 63976 50818. Certified technicians at your doorstep within 60 minutes with 30-day warranty.`,
        url: `${siteUrl}${pagePath}`,
        images: [
          {
            url: "/og-image.jpg",
  ...
  return {
    ...
    openGraph: {
      title: `Appliance Repair in ${locationTitle} | PROVISIONINGTECH Company`,
...
export default async function Home({ params }: PageProps) {
  ...
  const homeSiteUrl = (process.env.NEXT_PUBLIC_BASE_URL || "https://www.provisioningtech.com").replace(/\/$/, "");
