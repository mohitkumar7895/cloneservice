    ...
    <div className="fixed inset-0 z-[150] flex items-end sm:items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in duration-200 p-0 sm:p-4">
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-5">
          ...
          <div className="bg-gradient-to-br from-emerald-50/70 via-purple-50/40 to-amber-50/50 border border-emerald-100/80 rounded-2xl p-4 sm:p-5 flex items-center gap-4 sm:gap-6">
            <div className="flex flex-col items-center justify-center pr-4 sm:pr-6 border-r border-emerald-100 shrink-0">
        ...
        <div className="p-3 sm:p-4 bg-gray-50 border-t border-gray-100 flex justify-end">
          <button 
            onClick={onClose}
            className="w-full sm:w-auto bg-[#059669] hover:bg-[#047857] text-white font-bold px-6 py-2.5 rounded-xl text-xs sm:text-sm transition cursor-pointer"
          >
            Close
          </button>
        </div>
