...
export default function Hero({ categories = [], banners = [], hideHeadline = false }: HeroProps) {
  ...
  return (
    <div className="relative bg-linear-to-r from-[#059669] via-[#4f46e5] to-[#db5285] text-white w-full font-sans overflow-hidden py-4 md:py-8 px-4 md:px-10 lg:px-12">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-4 md:gap-6 items-start justify-between">
        ...
        <div className="w-full md:w-1/2 flex flex-col space-y-3 md:space-y-4 z-10">
          ...
          <div className="bg-white rounded-3xl p-5 sm:p-6 shadow-2xl text-gray-800 flex flex-col space-y-5">
            ...
            {/* Bottom Row: PROVISIONINGTECH PREMIUM PACKAGE (New Products & RO AMC) */}
            {(newProducts.length > 0 || amcProducts.length > 0) && (
              <div className="pt-2 w-full">
                <style dangerouslySetInnerHTML={{__html: `
                  ...
                  .provisioningtech-premium-gradient {
                ...
                `}} />
                <div className="mb-3">
                  <h3 className="provisioningtech-premium-gradient font-black text-[17px] sm:text-[19px] md:text-[20px] tracking-tight uppercase">
                    PROVISIONINGTECH PREMIUM PACKAGE
                  </h3>
                </div>
        ...
        <div className="w-full md:w-1/2 hidden md:flex items-stretch justify-center md:h-[550px]">
          <div className="flex gap-3 p-3 border-4 border-white/20 rounded-[28px] bg-white/10 shadow-xl backdrop-blur-sm w-full max-w-120 lg:max-w-130 h-full">
            ...
            <div className="w-1/2 h-full">
              <Image
                src="/hero_emerald.jpg"
                alt="PROVISIONINGTECH technician providing doorstep home appliance repair"
                width={600}
                height={800}
                priority
