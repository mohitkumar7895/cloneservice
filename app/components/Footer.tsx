...
export default function Footer() {
  return (
    <footer className="bg-[#059669] text-white py-12 font-sans border-t border-emerald-400/20">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10">
        
        {/* Column 1: Brand Info */}
        <div className="space-y-4">
          <Link href="/" className="inline-flex items-center bg-white rounded-xl px-3 py-2">
            <img src="/logoprovisioningtech.webp" alt="PROVISIONINGTECH Logo" className="h-10 w-auto object-contain" />
          </Link>
        ...
        <div>
          ...
          <div className="bg-[#10b981] rounded-xl p-5 space-y-3.5 shadow-inner border border-emerald-400/30">
            <div className="flex items-center space-x-3 text-sm">
              <Phone className="w-4 h-4 flex-shrink-0 text-blue-200" />
              <span className="font-medium">+91 63976 50818</span>
            </div>
            <div className="flex items-center space-x-3 text-sm">
              <Mail className="w-4 h-4 flex-shrink-0 text-blue-200" />
              <span className="font-medium">support@provisioningtech.com</span>
            </div>
      ...
      <div className="mt-10 text-center text-xs sm:text-sm text-blue-200 border-t border-blue-400/30 pt-6 px-4 flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2">
        <span>© 2026 Powered by PROVISIONINGTECH Company</span>
      </div>
    </footer>
  );
}
