      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-6">
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            <label className="text-[12px] font-extrabold text-[#059669] uppercase tracking-wider flex items-center gap-1.5 bg-[#f0effb] px-2.5 py-1 rounded-lg">
              <CalendarCheck className="w-4 h-4 text-[#059669]" /> Select Date
            </label>
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            <label className="text-[12px] font-extrabold text-[#059669] uppercase tracking-wider flex items-center gap-1.5 bg-[#f0effb] px-2.5 py-1 rounded-lg">
              <Clock className="w-4 h-4 text-[#059669]" /> Time Slots
            </label>
