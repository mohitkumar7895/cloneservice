  ...
  return (
    <div ref={wrapperRef} className={`relative w-full ${className}`}>
      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none z-10">
        {isLoading ? (
          <Loader2 className="h-4 w-4 text-[#059669] animate-spin" />
        ) : (
      ...
      <input
        ...
        className="block w-full pl-9 pr-3.5 py-2 lg:py-2.5 rounded-xl leading-5 bg-white border-[1.5px] border-[#059669]/60 hover:border-[#059669] text-gray-900 font-semibold focus:outline-none focus:ring-2 focus:ring-[#059669]/30 focus:border-[#059669] text-xs sm:text-sm transition-all shadow-xs relative z-0"
      />
