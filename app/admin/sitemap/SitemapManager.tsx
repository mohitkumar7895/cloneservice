  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-3xl p-4 sm:p-6 border border-gray-200/80 shadow-sm space-y-6">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500 text-xs sm:text-sm mt-1">
              Admin-only. Website visitors do not see this. Google reads <span className="font-mono text-emerald-700">/sitemap.xml</span> for ranking.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              <RefreshCw className={`w-3.5 h-3.5 ${syncing ? "animate-spin text-emerald-600" : "text-gray-500"}`} />
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-3.5 sm:px-4 py-2 text-xs font-bold text-white bg-gradient-to-r from-purple-600 to-emerald-600 hover:from-purple-700 hover:to-emerald-700 active:scale-95 rounded-xl shadow-md shadow-emerald-600/20 transition"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-3.5 sm:px-4 py-2 text-xs font-bold text-white bg-emerald-600 hover:bg-emerald-700 active:scale-95 rounded-xl shadow-md shadow-emerald-600/20 transition"
            >
        ...
        {showGuide && (
          <div className="bg-gradient-to-r from-emerald-50/90 via-purple-50/70 to-blue-50/90 border border-emerald-100 rounded-2xl p-4 sm:p-5 space-y-3 animate-in fade-in duration-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 text-xs text-emerald-950">
              <div className="bg-white/90 p-3.5 rounded-xl border border-emerald-100 shadow-xs space-y-1">
                <span className="font-bold text-emerald-700 block text-xs">1. Area-Wise SEO Kyun Zaroori Hai?</span>
              ...
              <div className="bg-white/90 p-3.5 rounded-xl border border-emerald-100 shadow-xs space-y-1">
                <span className="font-bold text-emerald-700 block text-xs">2. Bulk Area Builder Kaise Kaam Karta Hai?</span>
                <p className="text-gray-600 text-[11px] leading-relaxed">
              ...
              <div className="bg-white/90 p-3.5 rounded-xl border border-emerald-100 shadow-xs space-y-1">
                <span className="font-bold text-emerald-700 block text-xs">3. Real-Time Active Toggle</span>
                <p className="text-gray-600 text-[11px] leading-relaxed">
                  Kisi bhi link ke switch ko band karte hi wo Google ke <code className="bg-gray-100 px-1 rounded text-emerald-600 font-mono">/sitemap.xml</code> se turant hide ho jati hai bina code edit kiye.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-white rounded-3xl p-4 sm:p-5 border border-gray-200/80 shadow-sm space-y-4">
        <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3">
          ...
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              className="w-full bg-gray-50 border border-gray-300 rounded-xl pl-9 pr-8 py-2 text-xs text-gray-900 placeholder-gray-400 focus:outline-none focus:border-emerald-500 focus:bg-white transition"
            />
            {search && (
              <button
                onClick={() => setSearch("")}
        ...
        {selectedIds.length > 0 && (
          <div className="flex items-center justify-between bg-emerald-50 border border-emerald-200 px-4 py-2.5 rounded-xl animate-in fade-in duration-150">
          ...
          filteredLinks.map((link) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex items-start gap-2.5">
                    <input
                      ...
                      className="rounded border-gray-300 text-emerald-600 focus:ring-0 cursor-pointer mt-1"
                    />
                    <div>
                ...
                <div className="flex items-center justify-between gap-2 p-2 bg-slate-50 rounded-xl border border-slate-200/80 font-mono text-[11px] text-emerald-700">
                  <a
                    href={link.url}
                    target="_blank"
                    rel="noreferrer"
                ...
                <div className="flex items-center justify-between pt-1 border-t border-gray-100 text-xs">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="flex items-center gap-1 px-2.5 py-1 text-xs font-semibold text-gray-700 bg-gray-100 hover:bg-emerald-50 hover:text-emerald-600 rounded-lg transition"
                    >
              ...
              <tr className="bg-gray-50/80 border-b border-gray-200 text-gray-600 uppercase tracking-wider text-[11px] font-bold">
                <th className="p-4 w-10">
                  <input
                    ...
                    className="rounded border-gray-300 text-emerald-600 focus:ring-0 cursor-pointer"
                  />
                </th>
                  ...
                  return (
                    <tr
                      ...
                      className={`hover:bg-emerald-50/30 transition ${
                        isSelected ? "bg-emerald-50/50" : idx % 2 === 0 ? "bg-white" : "bg-gray-50/30"
                      }`}
                    >
                      {/* Checkbox */}
                      <td className="p-4">
                      ...
                      {/* URL */}
                      <td className="p-4 font-mono text-[11px] text-emerald-700 max-w-xs">
                        <div className="flex items-center gap-1.5">
                          ...
                          <button
                            onClick={() => copyToClipboard(link.url, link.id)}
                            className="text-gray-400 hover:text-emerald-600 transition shrink-0 p-1"
                            title="Copy URL"
                          >
                            {copiedId === link.id ? (
      ...
      {isAreaModalOpen && (
        ...
        >
          <div className="bg-white border border-gray-200/90 rounded-2xl sm:rounded-3xl w-full max-w-2xl shadow-2xl overflow-hidden flex flex-col max-h-[92vh] sm:max-h-[88vh] my-auto animate-in zoom-in-95 duration-200">
            {/* Modal Header: Sticky */}
            <div className="shrink-0 p-4 sm:p-6 bg-gradient-to-r from-purple-700 via-emerald-700 to-blue-700 text-white flex items-center justify-between border-b border-white/10">
            ...
            <form onSubmit={handleGenerateAreas} className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 sm:space-y-5 text-xs">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full bg-gray-50 border border-gray-300 rounded-xl px-3.5 py-2.5 text-gray-900 font-medium focus:outline-none focus:border-emerald-600 focus:bg-white transition"
                >
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full bg-gray-50 border border-gray-300 rounded-xl px-3.5 py-2 text-gray-900 font-semibold focus:outline-none focus:border-emerald-600 focus:bg-white"
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full bg-gray-50 border border-gray-300 rounded-xl p-3 text-gray-900 font-mono text-xs focus:outline-none focus:border-emerald-600 focus:bg-white"
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-gray-50 border border-gray-300 rounded-xl px-3 py-2 text-gray-900 font-medium focus:outline-none focus:border-emerald-600"
                  >
              ...
              <div className="pt-3 border-t border-gray-200 flex items-center justify-end gap-2.5 sm:gap-3">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="px-5 sm:px-6 py-2.5 bg-gradient-to-r from-purple-600 to-emerald-600 hover:from-purple-700 hover:to-emerald-700 text-white font-bold rounded-xl shadow-md transition active:scale-95 disabled:opacity-50"
                >
            ...
            <div className="shrink-0 p-4 sm:p-6 bg-slate-900 text-white flex items-center justify-between border-b border-slate-800">
              <div className="flex items-center gap-2.5">
                <div className="p-2 bg-white/10 rounded-xl">
                  {editingLink.id ? <Edit2 className="w-4 h-4 text-emerald-400" /> : <Plus className="w-4 h-4 text-emerald-400" />}
                </div>
            ...
            <form onSubmit={handleSaveSingleLink} className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-3.5 sm:space-y-4 text-xs">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-50 border border-gray-300 rounded-xl px-3.5 py-2 text-gray-900 font-mono focus:outline-none focus:border-emerald-600 focus:bg-white"
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-gray-50 border border-gray-300 rounded-xl px-3 py-2 text-gray-900 font-semibold focus:outline-none focus:border-emerald-600"
                  >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-50 border border-gray-300 rounded-xl px-3.5 py-2 text-gray-900 font-semibold focus:outline-none focus:border-emerald-600"
                />
              </div>
              ...
              <div className="pt-3 border-t border-gray-200 flex items-center justify-end gap-2.5 sm:gap-3">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl shadow-md transition active:scale-95 disabled:opacity-50"
                >
