...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-[#F8FAFC] font-sans overflow-hidden selection:bg-emerald-500/30">
          ...
          <div className="flex items-center flex-1">
            ...
            <div className="relative w-full max-w-md hidden md:block">
              ...
              <input 
                ...
                className="block w-full pl-10 pr-3 py-2 border border-gray-200 rounded-lg text-sm placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-gray-50 hover:bg-white focus:bg-white"
              />
            </div>
          </div>
