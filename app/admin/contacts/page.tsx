  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 font-sans bg-[#f8f9fa] min-h-screen space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-5 flex flex-col justify-between">
          <p className="text-emerald-600 text-xs font-bold uppercase tracking-wider mb-1">New / Unread</p>
          <h3 className="text-2xl font-black text-emerald-600 leading-none">{stats.new}</h3>
        </div>
                    ...
                    <td className="px-5 py-4">
                      {row.phone && (
                        <div className="flex items-center gap-1.5 text-xs font-semibold text-gray-800 mb-1">
                          ...
                          <a href={`tel:${row.phone}`} className="hover:text-emerald-600">{row.phone}</a>
                          <a 
                      ...
                      {row.email && (
                        <div className="flex items-center gap-1.5 text-xs text-gray-500">
                          ...
                          <a href={`mailto:${row.email}`} className="hover:text-emerald-600">{row.email}</a>
                        </div>
                      )}
