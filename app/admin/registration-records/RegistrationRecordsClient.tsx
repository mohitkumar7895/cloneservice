                  ...
                  <tr key={row.id} className="hover:bg-gray-50/80 transition align-middle">
                    ...
                    <td className="px-4 py-3 border-r border-gray-100 font-semibold">
                      <div className="flex items-center gap-1.5">
                        ...
                        <a
                          href={`https://wa.me/91${row.mobile}?text=${encodeURIComponent(`Hello ${row.name}, this is PROVISIONINGTECH Company regarding your technician registration.`)}`}
                          target="_blank"
                    ...
                    <td className="px-4 py-3 border-r border-gray-100">
                      <span className="bg-emerald-50 text-[#6b62d9] border border-emerald-100 text-[11px] font-bold px-2 py-0.5 rounded-full inline-block">
                        {row.experience}
                      </span>
                    </td>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden border border-gray-100">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex gap-2 pt-2">
                ...
                <a
                  href={`https://wa.me/91${selectedRecord.mobile}?text=${encodeURIComponent(`Hello ${selectedRecord.name}, this is PROVISIONINGTECH Company regarding your technician registration.`)}`}
                  target="_blank"
                  rel="noopener noreferrer"
