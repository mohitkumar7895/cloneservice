...
export default function AdminLogin() {
  ...
  const [targetEmail, setTargetEmail] = useState("mail.provisioningtech@gmail.com");
  ...
  const autoFetchAndFillOtp = useCallback(async (token: string) => {
    ...
    setAutoStatus("📡 Auto-detecting security code from mail.provisioningtech@gmail.com...");
  ...
  const handleCredentialsSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok && data.requires_otp) {
        ...
        setResendTimer(30);
        setCanResend(false);
        setSuccessMsg(data.message || `A 6-digit OTP code has been sent to mail.provisioningtech@gmail.com`);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center font-sans bg-[#090E17] relative overflow-hidden px-4 selection:bg-emerald-500/30">
      {/* Dynamic Background Glows */}
      <div className="absolute top-[-25%] left-[-15%] w-[60%] h-[60%] rounded-full bg-emerald-600/15 blur-[140px] pointer-events-none animate-pulse" />
      ...
      <div className="w-full max-w-md relative z-10 py-10">
        ...
        <div className="bg-[#111827]/90 backdrop-blur-2xl rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.6)] border border-slate-700/50 p-8 sm:p-10 text-white relative overflow-hidden">
          ...
          <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-emerald-500 via-emerald-400 to-emerald-500 animate-gradient" />

          {/* Header */}
          <div className="flex flex-col items-center text-center mb-8">
            <div className="relative mb-4">
              <div className="bg-gradient-to-br from-emerald-500 to-blue-600 p-3.5 rounded-2xl shadow-lg shadow-emerald-500/25 inline-flex items-center justify-center">
                {step === 1 ? (
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-white tracking-tight">
              {step === 1 ? "PROVISIONINGTECH Admin Portal" : "Two-Factor Authentication"}
            </h2>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3.5 bg-slate-900/90 border border-slate-700/80 rounded-xl text-white placeholder-slate-500 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all outline-none text-sm font-medium"
                    placeholder="admin@provisioningtech.com"
                  />
                </div>
              </div>
          ...
          {step === 2 && (
            <div className="space-y-6">
              ...
              <div className="bg-slate-900/90 border border-emerald-500/30 rounded-2xl p-4 text-center relative overflow-hidden">
                ...
                {autoStatus && (
                  <div className="mt-3 py-2 px-3 bg-emerald-950/70 border border-emerald-500/40 rounded-xl text-xs font-semibold text-emerald-200 flex items-center justify-center gap-2 animate-in fade-in zoom-in-95">
                    {autoDetecting ? (
                    ...
                    <input
                      ...
                      className={`w-11 sm:w-12 h-14 text-center text-2xl font-black font-mono rounded-xl bg-slate-900/90 border transition-all shadow-inner outline-none ${
                        digit
                          ...
                          : "border-slate-700/80 text-emerald-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/50"
                      }`}
                    />
                  ))}
                </div>
        ...
        <div className="text-center mt-6 text-xs text-slate-500">
          🔒 Secure Centralized Administrator Gateway • PROVISIONINGTECH Company
        </div>
      </div>
    </div>
  );
