...
export const metadata = {
  title: "Visit Bookings - PROVISIONINGTECH Admin",
};
    ...
    <div className="font-sans text-[13px] pb-12">
      ...
      <div className="bg-white border border-gray-200/80 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] overflow-hidden">
        ...
        <div className="p-4 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <ExportButtons tableId="visitBookingTable" filename="provisioningtech-visit-bookings" />
                ...
                bookings.map((row, index) => (
                  <tr key={row.id} className="hover:bg-slate-50/80 transition-colors text-[13px]">
                    ...
                    <td className="px-4 py-4 min-w-[200px]">
                      ...
                      <a href={`tel:${row.mobile}`} className="text-emerald-600 hover:text-emerald-800 text-xs font-semibold mb-1 block">
                        {row.mobile}
                      </a>
                    ...
                    <td className="px-4 py-4 max-w-[240px]">
                      <div className="inline-block bg-emerald-50 text-emerald-700 text-[10px] font-bold px-2 py-0.5 rounded-full mb-1 border border-emerald-100">
                    ...
                    <td className="px-4 py-4 text-center">
                      <a 
                        href={`https://wa.me/91${row.mobile}?text=Hello%20${encodeURIComponent(row.customer_name)},%20thank%20you%20for%20choosing%20PROVISIONINGTECH%20Company.%20Your%20visit%20for%20order%20%23${row.order_id}%20has%20been%20completed.`}
                        target="_blank"
                        rel="noreferrer"
