    ...
    <form onSubmit={handleSave} className="flex items-center space-x-2">
      <div className="relative">
        ...
        <input 
          ...
          className="w-24 pl-6 pr-3 py-1.5 bg-gray-50 border border-gray-200 rounded-lg text-[13px] font-bold text-gray-900 outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 focus:bg-white transition-all shadow-inner"
        />
      </div>
      <button 
        type="submit" 
        ...
        className={`px-3 py-1.5 rounded-lg text-[11px] font-bold transition-all flex items-center gap-1 ${
          saved 
            ...
            : "text-emerald-600 bg-emerald-50 hover:bg-emerald-100 hover:text-emerald-700 active:scale-95"
        }`}
      >
