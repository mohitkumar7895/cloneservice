  ...
  return (
    <>
      ...
      <button
        type="button"
        onClick={openModal}
        className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[11px] font-bold text-emerald-600 bg-emerald-50 hover:bg-emerald-100 hover:text-emerald-700 transition-all border border-emerald-200/80 shadow-2xs cursor-pointer active:scale-95"
      ...
      {mounted && isOpen && createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-3">
          ...
          >
            {/* Header */}
            <div className="px-4 py-3 bg-gradient-to-r from-gray-900 via-gray-800 to-emerald-950 text-white flex items-center justify-between">
              <div>
            ...
            <div className="p-3 overflow-y-auto space-y-3 flex-1 text-gray-800">
                          ...
                          <tr key={idx} className="hover:bg-gray-50/70 transition-colors">
                            <td className="px-3 py-2">
                              <input
                                ...
                                className="w-full px-2 py-1 bg-gray-50/80 border border-gray-200 rounded-lg text-[11px] font-semibold text-gray-900 focus:bg-white focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none"
                              />
                            </td>
                            <td className="px-3 py-2 text-center">
                              <input
                                ...
                                className="w-16 px-1.5 py-1 text-center bg-gray-50/80 border border-gray-200 rounded-lg text-[11px] font-bold text-gray-900 focus:bg-white focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none"
                              />
                            </td>
                            <td className="px-3 py-2 text-right">
                              <div className="relative inline-block w-24">
                                ...
                                <input
                                  ...
                                  className="w-full pl-5 pr-1.5 py-1 text-right bg-gray-50/80 border border-gray-200 rounded-lg text-[11px] font-bold text-gray-900 focus:bg-white focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none"
                                />
                              </div>
                            </td>
              ...
              <div className="p-3 bg-emerald-50/50 rounded-lg border border-emerald-100 space-y-2.5">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1.5 text-[11px] font-black text-emerald-950 uppercase tracking-wider">
                    <Plus className="w-3 h-3 text-emerald-600" />
                    <span>Add Extra Item / Spare Part / Service</span>
                  </div>
                  <span className="text-[11px] text-emerald-600 font-semibold flex items-center gap-1">
                    <Sparkles className="w-3 h-3 text-emerald-500" /> Auto-fill from Rate Card
                  </span>
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 bg-white border border-emerald-200 rounded-lg text-[11px] font-semibold text-gray-900 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none shadow-2xs"
                  >
                    <option value="">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-12 gap-2.5 items-end pt-1 border-t border-emerald-100/80">
                  <div className="sm:col-span-6">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-white border border-gray-200 rounded-lg text-[11px] font-medium text-gray-900 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none shadow-2xs"
                    />
                  </div>
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <input
                      ...
                      className="w-full px-2 py-2 text-center bg-white border border-gray-200 rounded-lg text-[11px] font-bold text-gray-900 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none shadow-2xs"
                    />
                  </div>
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <input
                      ...
                      onKeyDown={(e) => e.key === "Enter" && handleAddNewItem()}
                      className="w-full px-2 py-2 text-right bg-white border border-gray-200 rounded-lg text-[11px] font-bold text-gray-900 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none shadow-2xs"
                    />
                  ...
                  <div className="sm:col-span-2">
                    <button
                      ...
                      className="w-full py-2 px-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-[11px] font-bold transition flex items-center justify-center gap-1 shadow-xs active:scale-95"
                    >
