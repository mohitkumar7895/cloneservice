...
export default function AddressViewButton({ booking }: AddressModalProps) {
  ...
  const whatsappText = `*PROVISIONINGTECH COMPANY - NEW BOOKING*
----------------------------------------
  ...
  return (
    <>
      ...
      <button
        ...
        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gradient-to-r from-emerald-50 to-violet-50 text-emerald-700 hover:from-emerald-600 hover:to-violet-600 hover:text-white border border-emerald-200/90 text-[11px] font-extrabold tracking-tight transition-all duration-200 shadow-sm hover:shadow-md hover:scale-[1.02] mt-1.5 group"
        title="View Address & Live Location"
      >
        <MapPin className="w-3 h-3 text-emerald-500 group-hover:text-white transition-colors" />
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100 sticky top-0 bg-white/95 backdrop-blur-md rounded-t-[28px] z-10">
              <div className="flex items-center gap-2">
                <div className="w-11 h-11 bg-gradient-to-br from-emerald-600 via-emerald-700 to-violet-700 rounded-lg flex items-center justify-center shadow-lg shadow-emerald-500/25 text-white">
                  <Navigation className="w-3 h-3" />
                </div>
                <div>
                  <div className="flex items-center gap-2">
                    <h2 className="text-[16px] font-black text-slate-900 tracking-tight leading-tight">Booking Dispatch</h2>
                    <span className="px-2 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-emerald-50 text-emerald-600 border border-emerald-100">
                      Live
                    </span>
                  </div>
            ...
            <div className="p-3 space-y-3">
              ...
              <div className="flex items-center justify-between bg-gradient-to-r from-violet-600 to-emerald-600 text-white px-4 py-2.5 rounded-lg shadow-sm">
                <div className="flex items-center gap-2">
                  <Sparkles className="w-3 h-3 text-amber-300 animate-pulse" />
                  <span className="text-[11px] font-black uppercase tracking-widest text-emerald-100">Category</span>
                </div>
              ...
              <div className="bg-gradient-to-br from-blue-50/90 via-emerald-50/40 to-slate-50/80 rounded-lg p-3 border border-blue-100 shadow-sm">
