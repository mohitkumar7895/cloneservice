  ...
  return (
    <div className="relative w-full lg:w-80">
      ...
      <input
        ...
        className="w-full pl-9 pr-8 py-2 bg-white border border-gray-200 rounded-xl text-[13px] outline-none focus:border-emerald-600 focus:ring-4 focus:ring-emerald-500/10 hover:border-gray-300 transition-all text-gray-900 placeholder:text-gray-400 shadow-xs font-medium"
      />
      {query && (
        <button
          onClick={() => setQuery("")}
