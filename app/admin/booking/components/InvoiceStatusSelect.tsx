    ...
    <div className="inline-flex flex-col items-center gap-1">
      ...
      {isCompleted && orderId && (
        <Link
          ...
          target="_blank"
          className="inline-flex items-center gap-1 text-[10px] font-black text-emerald-700 hover:text-emerald-900 bg-emerald-50 hover:bg-emerald-100 px-2 py-0.5 rounded-md border border-emerald-200 shadow-xs transition-all mt-0.5"
