...
export const metadata = {
  title: "New Product Bookings - PROVISIONINGTECH Admin",
};
    ...
    <div className="font-sans text-[13px] pb-12">
      ...
      <div className="bg-white border border-gray-200/80 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] overflow-hidden">
        ...
        <div className="p-4 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <ExportButtons tableId="newProductBookingTable" filename="provisioningtech-new-products" />
                ...
                bookings.map((row, index) => (
                  <tr key={row.id} className="hover:bg-slate-50/80 transition-colors text-[13px]">
                    ...
                    <td className="px-4 py-4 text-center">
                      <a 
                        href={`https://wa.me/91${row.mobile}?text=Hello%20${encodeURIComponent(row.customer_name)},%20your%20Product%20Order%20%23${row.order_id}%20has%20been%20confirmed%20with%20PROVISIONINGTECH%20Company.`}
                        target="_blank"
                        rel="noreferrer"
