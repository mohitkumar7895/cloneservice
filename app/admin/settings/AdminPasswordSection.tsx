  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
      ...
      <div className="p-6 md:p-8">
        ...
        {/* OTP Sent Alert */}
        {otpSentMessage && (
          <div className="mb-6 p-4 bg-emerald-50 border border-emerald-200 rounded-xl flex items-start gap-3 text-emerald-900 text-sm font-medium animate-in fade-in duration-200">
            <Mail className="w-5 h-5 text-emerald-600 shrink-0 mt-0.5" />
            <div className="flex-1">
              <p className="font-bold">OTP Dispatched</p>
              <p className="mt-0.5 text-xs text-emerald-700">{otpSentMessage}</p>
            </div>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full px-4 py-3 pr-12 rounded-xl border border-gray-200 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all font-medium text-gray-900 bg-white"
              />
              <button
                type="button"
          ...
          <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-5 space-y-3">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-1.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 font-bold px-4 py-2 rounded-xl text-xs border border-emerald-200 transition disabled:opacity-50 disabled:cursor-not-allowed shrink-0 cursor-pointer"
              >
                {isSendingOtp ? (
                  <>
            ...
            <div className="max-w-xs">
              <input
                ...
                maxLength={6}
                required
                className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all font-mono font-bold tracking-widest text-base text-gray-900 bg-white"
              />
            </div>
          </div>
          ...
          <div className="pt-4 border-t border-gray-100 flex items-center justify-between">
            <button
              ...
              className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3 px-8 rounded-xl transition-all shadow-md hover:shadow-emerald-500/20 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
            >
              {isLoading ? (
                <>
