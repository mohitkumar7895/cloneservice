      ...
      <div className="flex flex-wrap items-center gap-1.5">
        <Link
          ...
          className={`px-3 py-1.5 rounded-lg text-xs font-semibold border ${
            page <= 1 ? "pointer-events-none opacity-40 border-gray-200 text-gray-400" : "border-gray-200 text-gray-700 hover:bg-emerald-50 hover:text-emerald-700"
          }`}
        >
          Prev
        </Link>
        ...
        <Link
          ...
          prefetch
          className={`px-3 py-1.5 rounded-lg text-xs font-semibold border ${
            page >= totalPages ? "pointer-events-none opacity-40 border-gray-200 text-gray-400" : "border-gray-200 text-gray-700 hover:bg-emerald-50 hover:text-emerald-700"
          }`}
        >
          Next
        </Link>
