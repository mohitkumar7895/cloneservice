            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5 md:col-span-2">
                ...
                <input
                  ...
                  placeholder="support@provisioningtech.com"
                  className="w-full border border-gray-300 rounded-lg px-3.5 py-2.5 text-sm outline-none focus:border-blue-500"
                />
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 space-y-6">
            <div className="flex items-center justify-between border-b border-gray-100 pb-3">
              ...
              <button
                ...
                className="bg-emerald-50 hover:bg-emerald-100 text-[#6b62d9] font-bold px-3.5 py-1.5 rounded-lg text-xs flex items-center space-x-1.5 transition"
              >
