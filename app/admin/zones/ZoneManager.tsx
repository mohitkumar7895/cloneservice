                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <button
                      ...
                      className="bg-emerald-50 hover:bg-emerald-100 text-[#6b62d9] font-bold text-xs px-2.5 py-1 rounded-md border border-emerald-100 transition"
                    >
                      📍 Noida / NCR
                    </button>
                    <button
                  ...
                  return (
                    <div
                      ...
                      className={`p-3 rounded-xl border cursor-pointer transition flex items-center space-x-3 ${
                        isChecked
                          ? "bg-emerald-50/80 border-[#6b62d9] shadow-sm text-gray-900"
