      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="p-6 border-b border-gray-100 bg-gray-50/50">
          ...
          <div className="flex gap-4">
            <label className={`flex-1 flex flex-col items-center justify-center p-6 rounded-xl border-2 cursor-pointer transition-all ${adType === 'video' ? 'border-[#059669] bg-emerald-50/50 text-[#059669]' : 'border-gray-200 hover:border-gray-300 text-gray-500'}`}>
            ...
            <label className={`flex-1 flex flex-col items-center justify-center p-6 rounded-xl border-2 cursor-pointer transition-all ${adType === 'image' ? 'border-[#059669] bg-emerald-50/50 text-[#059669]' : 'border-gray-200 hover:border-gray-300 text-gray-500'}`}>
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <input
                ...
                className="w-32 px-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#059669] focus:border-transparent outline-none font-medium"
              />
                ...
                {videoSourceType === 'url' ? (
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#059669] focus:border-transparent outline-none text-sm font-medium"
                    />
                  ...
                  <>
                    ...
                    <button
                      ...
                      className="w-full py-8 border-2 border-dashed border-gray-300 rounded-xl hover:border-[#059669] hover:bg-emerald-50/30 transition-all flex flex-col items-center justify-center gap-2 group"
                    >
                      <div className="w-12 h-12 bg-gray-100 group-hover:bg-emerald-100 rounded-full flex items-center justify-center transition-colors">
                        <Upload className="w-5 h-5 text-gray-400 group-hover:text-[#059669] transition-colors" />
                      </div>
                      <span className="font-bold text-sm text-gray-700 group-hover:text-[#059669] transition-colors">
                ...
                {saving && adType === 'video' && videoFile && (
                  <div className="space-y-2">
                    ...
                    <div className="w-full h-3 bg-gray-100 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-gradient-to-r from-[#059669] to-emerald-400 rounded-full transition-all duration-300"
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-4">
                  ...
                  {imageFiles.length < 6 && (
                    <button
                      ...
                      className="aspect-[4/3] border-2 border-dashed border-gray-300 rounded-xl hover:bg-gray-50 hover:border-[#059669] transition flex flex-col items-center justify-center text-gray-400 group"
                    >
                      <ImageIcon className="w-6 h-6 mb-2 group-hover:scale-110 transition-transform group-hover:text-[#059669]" />
                      <span className="text-sm font-medium group-hover:text-[#059669]">Add Image</span>
        ...
        <div className="p-6 border-t border-gray-100 bg-gray-50/50 flex items-center justify-between">
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="flex items-center gap-2 bg-[#059669] hover:bg-[#047857] text-white font-bold py-3 px-8 rounded-xl transition shadow-md disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {saving ? (
