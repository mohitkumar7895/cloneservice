...
export const metadata: Metadata = {
  title: "Page not found | PROVISIONINGTECH Company",
  ...
  return (
    <main className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-grow flex flex-col items-center justify-center px-6 py-20 text-center">
        <p className="text-sm font-bold text-[#059669] uppercase tracking-widest">404</p>
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          <Link
            href="/"
            className="bg-[#059669] text-white font-semibold px-5 py-2.5 rounded-xl"
          >
            Go Home
          </Link>
          <Link
