        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden print:shadow-none print:rounded-none print:border-0">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 print:hidden">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-black text-gray-900 text-sm leading-tight"><span className="text-emerald-600">PROVISIONINGTECH</span> Company</p>
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={handlePrint}
                className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2 rounded-lg text-sm font-bold transition-all shadow-sm"
              >
          ...
          <div className="p-6 sm:p-10">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-8">
              <div>
                <Image
                  ...
                  priority
                />
                <p className="text-xs text-gray-500 font-medium">support@provisioningtech.com</p>
                {showGstNumber && (
            ...
            <div className="mt-8 pt-6 border-t border-gray-100">
              ...
              <p className="text-[11px] text-gray-400 mt-3">
                This is a computer-generated invoice and does not require a physical signature. Thank you for choosing PROVISIONINGTECH Company.
              </p>
            </div>
