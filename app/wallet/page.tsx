    ...
    <main className="min-h-screen bg-[#f7f8fc] flex flex-col font-sans">
      ...
      <div className="flex-1 max-w-4xl w-full mx-auto p-4 sm:p-6 lg:p-8 mt-4 pb-20">
        ...
        <div className="flex items-center gap-4 mb-8 mt-2">
          ...
          <div>
            <h1 className="text-3xl sm:text-4xl font-black text-gray-900 tracking-tight">PROVISIONINGTECH Company Wallet</h1>
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="text-sm font-semibold text-[#059669] hover:text-[#047857]">View All</button>
          </div>
