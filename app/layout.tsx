...
export const metadata: Metadata = {
  ...
  title: "PROVISIONINGTECH Company - Doorstep Appliance Repair & Maintenance Experts",
  description:
    "Book certified doorstep repair & maintenance for RO water purifiers, refrigerators, washing machines, and ACs with PROVISIONINGTECH Company. 30-day warranty, transparent pricing & verified experts across Delhi NCR.",
  keywords: [
    ...
    "PROVISIONINGTECH Company",
  ],
  authors: [{ name: "PROVISIONINGTECH Company", url: siteUrl }],
  creator: "PROVISIONINGTECH Company",
  publisher: "PROVISIONINGTECH Company",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
  ...
  openGraph: {
    ...
    locale: "en_IN",
    url: siteUrl,
    siteName: "PROVISIONINGTECH Company",
    title: "PROVISIONINGTECH Company - Doorstep Appliance Repair & Maintenance Experts",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "PROVISIONINGTECH Company - Doorstep Appliance Repair Services",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "PROVISIONINGTECH Company - Doorstep Appliance Repair & Maintenance",
    description:
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  const organizationSchema = {
    ...
    sameAs: ["https://www.provisioningtech.com"],
  };
