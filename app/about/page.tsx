...
export const metadata: Metadata = {
  title: "About Us - PROVISIONINGTECH Company | Doorstep Appliance Repair Specialists",
  description:
    "Learn about PROVISIONINGTECH Company, Delhi NCR's trusted home appliance service partner. Certified technicians specializing in RO water purifiers, refrigerator repair, washing machines, and AC servicing.",
  alternates: {
  ...
  openGraph: {
    title: "About Us - PROVISIONINGTECH Company | Doorstep Appliance Repair Specialists",
    description:
      "PROVISIONINGTECH Company delivers dependable, affordable doorstep home appliance repairs across Noida, Greater Noida, Delhi, Ghaziabad & Gurgaon.",
    url: `${siteUrl}/about`,
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "About PROVISIONINGTECH Company",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "About PROVISIONINGTECH Company - Home Appliance Care",
    description:
  ...
  const aboutSchema = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "url": `${siteUrl}/about`,
        "name": "About PROVISIONINGTECH Company",
        "description":
          "PROVISIONINGTECH Company is a premier doorstep home appliance repair and maintenance provider in Delhi NCR.",
        "publisher": {
          "@type": "Organization",
    ...
    <main className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <div className="bg-[#6b46c1] text-white py-16 px-8 flex justify-center">
        <div className="max-w-6xl w-full">
          <h1 className="text-4xl font-bold mb-3 tracking-wide">About PROVISIONINGTECH Company</h1>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 md:p-12">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed text-sm md:text-base">
              PROVISIONINGTECH Company is a trusted home service provider offering reliable and affordable appliance repair and maintenance services. We understand how important your home appliances are to your daily life, and we're here to keep them running smoothly.
            </p>
          </section>
