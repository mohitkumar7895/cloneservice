      ...
      <div className="flex justify-between gap-3 sm:gap-6 items-start">
        ...
        <div className="flex-1 min-w-0">
          ...
          <button 
            ...
            className="text-[#059669] text-xs sm:text-sm font-semibold hover:underline cursor-pointer"
          >
            View details →
          </button>
        </div>
        ...
        <div className="relative w-[116px] sm:w-[150px] flex-shrink-0 self-start pb-3.5 -mr-0.5 sm:mr-0">
          ...
          {quantity > 0 ? (
            <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 bg-white border border-gray-200 text-[#059669] text-sm sm:text-[15px] font-bold h-8 sm:h-9.5 w-[88px] sm:w-[105px] rounded-xl shadow-[0_4px_16px_rgba(0,0,0,0.12)] flex items-center justify-between px-2 z-10">
              <button 
