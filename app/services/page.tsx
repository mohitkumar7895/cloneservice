...
const rawBaseUrl = process.env.NEXT_PUBLIC_BASE_URL || "https://www.provisioningtech.com";
const siteUrl = rawBaseUrl.endsWith("/") ? rawBaseUrl.slice(0, -1) : rawBaseUrl;

export const metadata: Metadata = {
  title: "Doorstep Appliance Repair Services | RO, Refrigerator & Washing Machine | PROVISIONINGTECH Company",
  description:
    "Explore PROVISIONINGTECH Company's complete doorstep appliance repair services: RO water purifier repair & AMC, refrigerator troubleshooting, washing machine maintenance, and AC repair in Delhi NCR with 30-day warranty.",
  alternates: {
    canonical: `${siteUrl}/services`,
  },
  openGraph: {
    title: "Appliance Repair Services | RO, Refrigerator & Washing Machine - PROVISIONINGTECH Company",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "PROVISIONINGTECH Company Doorstep Services",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Doorstep Appliance Repair Services | PROVISIONINGTECH Company",
    description:
...
export default async function ServicesPage() {
  ...
  const faqs = [
    ...
    {
      q: "What is included in PROVISIONINGTECH Company's 30-Day Service Warranty?",
      a: "Every repair job completed by PROVISIONINGTECH Company includes a 30-day service warranty. If the same issue recurs within 30 days of the repair, our technician will inspect and resolve it free of charge.",
    },
    {
        ...
        "itemListElement": [
          {
            ...
            "provider": { "@type": "LocalBusiness", "name": "PROVISIONINGTECH Company" }
          },
          {
            "@type": "Service",
            "position": 2,
    ...
    <main className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <section className="bg-gradient-to-br from-[#1e1b4b] via-[#312e81] to-[#4338ca] text-white py-14 lg:py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-xs sm:text-sm font-medium text-emerald-200 mb-6">
          ...
          <p className="max-w-3xl mx-auto text-base sm:text-lg lg:text-xl text-emerald-100/90 leading-relaxed mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-4xl mx-auto text-left">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3.5 border border-white/10 flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-emerald-200">Warranty</p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3.5 border border-white/10 flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-emerald-200">Speed</p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3.5 border border-white/10 flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-emerald-200">Quality</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16 w-full">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl border border-emerald-100 shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden flex flex-col">
              <div className="bg-gradient-to-r from-emerald-600 to-violet-600 p-6 text-white relative">
                <div className="w-12 h-12 rounded-xl bg-white/20 backdrop-blur-md flex items-center justify-center mb-4">
                ...
                <p className="text-emerald-100 text-sm mt-1">Single, Double Door, Side-by-Side &amp; Inverter</p>
              </div>
                ...
                <div>
                  <div className="border-t border-gray-100 pt-4 mb-4 flex items-baseline justify-between">
                    <div>
                      ...
                      <span className="text-2xl font-extrabold text-emerald-700">₹199</span>
                    </div>
                    <span className="text-xs bg-emerald-50 text-emerald-700 font-semibold px-2 py-1 rounded-md border border-emerald-200">
                      30-Day Warranty
                    </span>
                  </div>
                  ...
                  <Link
                    ...
                    className="w-full inline-flex items-center justify-center gap-1.5 py-2.5 px-4 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-sm font-semibold transition"
                  >
            ...
            {categories.map((cat) => {
              ...
              return (
                <Link
                  ...
                  className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-emerald-300 shadow-sm hover:shadow-md transition-all duration-200 flex flex-col justify-between"
                >
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <div className="w-12 h-12 rounded-xl bg-emerald-50 group-hover:bg-emerald-600 transition-colors flex items-center justify-center">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-8 lg:p-10 mb-16 shadow-sm">
          <div className="text-center max-w-2xl mx-auto mb-10">
            <h2 className="text-2xl font-bold text-gray-900">Why Delhi NCR Trusts PROVISIONINGTECH Company</h2>
            <p className="text-gray-600 text-sm mt-1">
        ...
        <div className="bg-gradient-to-r from-gray-900 to-emerald-950 rounded-3xl p-8 sm:p-12 text-white text-center sm:text-left flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl">
          <div>
            <span className="text-emerald-400 text-xs uppercase font-bold tracking-widest block mb-2">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
            <a
              href="tel:+916397650818"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-emerald-600 hover:bg-emerald-500 text-white font-bold rounded-xl shadow-lg transition"
            >
              <PhoneCall className="w-4 h-4" /> Call +91 63976 50818
            </a>
            <Link
              href="/contact"
